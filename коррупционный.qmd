...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/коррупционный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=коррупционный)


```{r, child='data/коррупционный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/коррупционный.qmd'}
```
