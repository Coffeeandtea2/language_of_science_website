...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/рождаемость)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=рождаемость)


```{r, child='data/рождаемость.html'}
```
::: {.panel-tabset}
