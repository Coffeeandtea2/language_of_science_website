...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/дискриминация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=дискриминация)


```{r, child='data/дискриминация.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/дискриминация.qmd'}
```
