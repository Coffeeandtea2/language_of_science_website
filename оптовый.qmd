...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/оптовый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=оптовый)


```{r, child='data/оптовый.html'}
```
::: {.panel-tabset}
