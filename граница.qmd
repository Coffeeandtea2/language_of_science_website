...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/граница)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=граница)


```{r, child='data/граница.html'}
```
::: {.panel-tabset}
