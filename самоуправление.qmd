...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/самоуправление)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=самоуправление)


```{r, child='data/самоуправление.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/самоуправление.qmd'}
```
