...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/график)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=график)


```{r, child='data/график.html'}
```
::: {.panel-tabset}
