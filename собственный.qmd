...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/собственный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=собственный)


```{r, child='data/собственный.html'}
```
::: {.panel-tabset}
