...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/вклад)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=вклад)


```{r, child='data/вклад.html'}
```
::: {.panel-tabset}
