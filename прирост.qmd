...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/прирост)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=прирост)


```{r, child='data/прирост.html'}
```
::: {.panel-tabset}
