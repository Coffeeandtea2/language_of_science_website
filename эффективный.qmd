...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/эффективный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=эффективный)


```{r, child='data/эффективный.html'}
```
::: {.panel-tabset}
