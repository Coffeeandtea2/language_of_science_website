...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/критерий)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=критерий)


```{r, child='data/критерий.html'}
```
::: {.panel-tabset}
