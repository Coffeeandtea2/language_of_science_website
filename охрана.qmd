...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/охрана)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=охрана)


```{r, child='data/охрана.html'}
```
::: {.panel-tabset}
