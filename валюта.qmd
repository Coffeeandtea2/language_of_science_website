...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/валюта)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=валюта)


```{r, child='data/валюта.html'}
```
::: {.panel-tabset}
