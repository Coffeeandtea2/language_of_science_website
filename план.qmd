...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/план)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=план)


```{r, child='data/план.html'}
```
::: {.panel-tabset}
