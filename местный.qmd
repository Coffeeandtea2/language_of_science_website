...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/местный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=местный)


```{r, child='data/местный.html'}
```
::: {.panel-tabset}
