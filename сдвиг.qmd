...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сдвиг)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сдвиг)


```{r, child='data/сдвиг.html'}
```
::: {.panel-tabset}
