...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/отходы)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=отходы)


```{r, child='data/отходы.html'}
```
::: {.panel-tabset}
