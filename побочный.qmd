...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/побочный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=побочный)


```{r, child='data/побочный.html'}
```
::: {.panel-tabset}
