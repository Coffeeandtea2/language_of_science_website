...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/рациональный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=рациональный)


```{r, child='data/рациональный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/рациональный.qmd'}
```
