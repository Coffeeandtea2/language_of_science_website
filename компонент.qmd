...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/компонент)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=компонент)


```{r, child='data/компонент.html'}
```
::: {.panel-tabset}
