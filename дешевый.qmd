...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/дешевый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=дешевый)


```{r, child='data/дешевый.html'}
```
::: {.panel-tabset}
