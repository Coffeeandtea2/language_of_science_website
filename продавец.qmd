...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/продавец)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=продавец)


```{r, child='data/продавец.html'}
```
::: {.panel-tabset}
