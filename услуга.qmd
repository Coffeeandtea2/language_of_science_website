...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/услуга)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=услуга)


```{r, child='data/услуга.html'}
```
::: {.panel-tabset}
