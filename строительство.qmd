...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/строительство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=строительство)


```{r, child='data/строительство.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/строительство.qmd'}
```
