...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/монополия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=монополия)


```{r, child='data/монополия.html'}
```
::: {.panel-tabset}
