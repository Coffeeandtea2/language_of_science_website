...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/тенденция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=тенденция)


```{r, child='data/тенденция.html'}
```
::: {.panel-tabset}
