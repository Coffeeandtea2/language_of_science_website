...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/производительность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=производительность)


```{r, child='data/производительность.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'производительность') |> 
...
```{r, child='tasks/производительность.qmd'}
```
