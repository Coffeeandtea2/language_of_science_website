...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/соотношение)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=соотношение)


```{r, child='data/соотношение.html'}
```
::: {.panel-tabset}
