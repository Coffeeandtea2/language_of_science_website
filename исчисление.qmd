...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/исчисление)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=исчисление)


```{r, child='data/исчисление.html'}
```
::: {.panel-tabset}
