...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/получатель)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=получатель)


```{r, child='data/получатель.html'}
```
::: {.panel-tabset}
