...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/пеня)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=пеня)


```{r, child='data/пеня.html'}
```
::: {.panel-tabset}
