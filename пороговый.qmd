...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/пороговый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=пороговый)


```{r, child='data/пороговый.html'}
```
::: {.panel-tabset}
