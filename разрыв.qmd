...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/разрыв)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=разрыв)


```{r, child='data/разрыв.html'}
```
::: {.panel-tabset}
