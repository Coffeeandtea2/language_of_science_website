...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/глобализация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=глобализация)


```{r, child='data/глобализация.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/глобализация.qmd'}
```
