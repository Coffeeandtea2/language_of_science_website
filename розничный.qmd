...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/розничный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=розничный)


```{r, child='data/розничный.html'}
```
::: {.panel-tabset}
