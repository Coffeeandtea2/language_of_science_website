...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/экономия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=экономия)


```{r, child='data/экономия.html'}
```
::: {.panel-tabset}
