...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/обменный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=обменный)


```{r, child='data/обменный.html'}
```
::: {.panel-tabset}
