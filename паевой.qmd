...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/паевой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=паевой)


```{r, child='data/паевой.html'}
```
::: {.panel-tabset}
