...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/фиктивный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=фиктивный)


```{r, child='data/фиктивный.html'}
```
::: {.panel-tabset}
