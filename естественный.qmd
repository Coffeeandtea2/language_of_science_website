...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/естественный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=естественный)


```{r, child='data/естественный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/естественный.qmd'}
```
