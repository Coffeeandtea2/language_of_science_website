...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/условие)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=условие)


```{r, child='data/условие.html'}
```
::: {.panel-tabset}
