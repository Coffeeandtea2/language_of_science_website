...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/отрицательный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=отрицательный)


```{r, child='data/отрицательный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/отрицательный.qmd'}
```
