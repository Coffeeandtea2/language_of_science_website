...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/заимствование)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=заимствование)


```{r, child='data/заимствование.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/заимствование.qmd'}
```
