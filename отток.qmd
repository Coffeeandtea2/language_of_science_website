...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/отток)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=отток)


```{r, child='data/отток.html'}
```
::: {.panel-tabset}
