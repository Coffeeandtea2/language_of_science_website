...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/инновационный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=инновационный)


```{r, child='data/инновационный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/инновационный.qmd'}
```
