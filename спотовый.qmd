...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/спотовый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=спотовый)


```{r, child='data/спотовый.html'}
```
::: {.panel-tabset}
