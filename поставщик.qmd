...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/поставщик)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=поставщик)


```{r, child='data/поставщик.html'}
```
::: {.panel-tabset}
