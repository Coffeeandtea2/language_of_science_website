...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/польза)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=польза)


```{r, child='data/польза.html'}
```
::: {.panel-tabset}
