...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/канал)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=канал)


```{r, child='data/канал.html'}
```
::: {.panel-tabset}
