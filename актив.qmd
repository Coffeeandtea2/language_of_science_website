...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/актив)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=актив)


```{r, child='data/актив.html'}
```
::: {.panel-tabset}
