...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/развитый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=развитый)


```{r, child='data/развитый.html'}
```
::: {.panel-tabset}
