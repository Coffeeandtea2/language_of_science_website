...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/законодательство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=законодательство)


```{r, child='data/законодательство.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/законодательство.qmd'}
```
