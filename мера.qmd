...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/мера)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=мера)


```{r, child='data/мера.html'}
```
::: {.panel-tabset}
