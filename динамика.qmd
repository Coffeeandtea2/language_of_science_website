...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/динамика)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=динамика)


```{r, child='data/динамика.html'}
```
::: {.panel-tabset}
