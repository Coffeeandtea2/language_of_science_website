...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ряд)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ряд)


```{r, child='data/ряд.html'}
```
::: {.panel-tabset}
