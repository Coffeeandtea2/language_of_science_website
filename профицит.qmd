...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/профицит)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=профицит)


```{r, child='data/профицит.html'}
```
::: {.panel-tabset}
