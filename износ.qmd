...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/износ)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=износ)


```{r, child='data/износ.html'}
```
::: {.panel-tabset}
