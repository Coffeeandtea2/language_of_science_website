...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/счетный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=счетный)


```{r, child='data/счетный.html'}
```
::: {.panel-tabset}
