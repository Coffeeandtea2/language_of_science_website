...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/промышленник)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=промышленник)


```{r, child='data/промышленник.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/промышленник.qmd'}
```
