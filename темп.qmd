...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/темп)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=темп)


```{r, child='data/темп.html'}
```
::: {.panel-tabset}
