...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/предложение)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=предложение)


```{r, child='data/предложение.html'}
```
::: {.panel-tabset}
