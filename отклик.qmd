...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/отклик)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=отклик)


```{r, child='data/отклик.html'}
```
::: {.panel-tabset}
