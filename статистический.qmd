...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/статистический)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=статистический)


```{r, child='data/статистический.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/статистический.qmd'}
```
