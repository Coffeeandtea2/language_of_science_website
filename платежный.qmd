...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/платежный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=платежный)


```{r, child='data/платежный.html'}
```
::: {.panel-tabset}
