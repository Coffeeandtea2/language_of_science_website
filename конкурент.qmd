...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/конкурент)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=конкурент)


```{r, child='data/конкурент.html'}
```
::: {.panel-tabset}
