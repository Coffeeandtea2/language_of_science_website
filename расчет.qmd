...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/расчет)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=расчет)


```{r, child='data/расчет.html'}
```
::: {.panel-tabset}
