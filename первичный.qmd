...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/первичный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=первичный)


```{r, child='data/первичный.html'}
```
::: {.panel-tabset}
