...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/предприниматель)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=предприниматель)


```{r, child='data/предприниматель.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/предприниматель.qmd'}
```
