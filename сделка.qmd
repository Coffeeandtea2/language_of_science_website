...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сделка)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сделка)


```{r, child='data/сделка.html'}
```
::: {.panel-tabset}
