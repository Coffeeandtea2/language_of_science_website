...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ущерб)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ущерб)


```{r, child='data/ущерб.html'}
```
::: {.panel-tabset}
