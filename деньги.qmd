...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/деньги)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=деньги)


```{r, child='data/деньги.html'}
```
::: {.panel-tabset}
