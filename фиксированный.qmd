...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/фиксированный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=фиксированный)


```{r, child='data/фиксированный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/фиксированный.qmd'}
```
