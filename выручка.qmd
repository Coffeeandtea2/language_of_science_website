...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/выручка)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=выручка)


```{r, child='data/выручка.html'}
```
::: {.panel-tabset}
