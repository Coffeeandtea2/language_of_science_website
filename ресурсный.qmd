...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ресурсный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ресурсный)


```{r, child='data/ресурсный.html'}
```
::: {.panel-tabset}
