...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/оптимальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=оптимальный)


```{r, child='data/оптимальный.html'}
```
::: {.panel-tabset}
