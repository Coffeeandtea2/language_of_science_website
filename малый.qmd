...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/малый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=малый)


```{r, child='data/малый.html'}
```
::: {.panel-tabset}
