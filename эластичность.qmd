...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/эластичность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=эластичность)


```{r, child='data/эластичность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/эластичность.qmd'}
```
