...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сбережение)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сбережение)


```{r, child='data/сбережение.html'}
```
::: {.panel-tabset}
