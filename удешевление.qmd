...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/удешевление)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=удешевление)


```{r, child='data/удешевление.html'}
```
::: {.panel-tabset}
