...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/периферия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=периферия)


```{r, child='data/периферия.html'}
```
::: {.panel-tabset}
