...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/позиция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=позиция)


```{r, child='data/позиция.html'}
```
::: {.panel-tabset}
