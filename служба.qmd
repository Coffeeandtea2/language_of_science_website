...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/служба)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=служба)


```{r, child='data/служба.html'}
```
::: {.panel-tabset}
