...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/среднедушевый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=среднедушевый)


```{r, child='data/среднедушевый.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/среднедушевый.qmd'}
```
