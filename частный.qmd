...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/частный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=частный)


```{r, child='data/частный.html'}
```
::: {.panel-tabset}
