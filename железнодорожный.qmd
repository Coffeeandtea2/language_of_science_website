...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/железнодорожный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=железнодорожный)


```{r, child='data/железнодорожный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/железнодорожный.qmd'}
```
