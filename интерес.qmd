...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/интерес)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=интерес)


```{r, child='data/интерес.html'}
```
::: {.panel-tabset}
