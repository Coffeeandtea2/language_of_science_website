...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/недостаток)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=недостаток)


```{r, child='data/недостаток.html'}
```
::: {.panel-tabset}
