...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/результат)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=результат)


```{r, child='data/результат.html'}
```
::: {.panel-tabset}
