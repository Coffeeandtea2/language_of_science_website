...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/линейный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=линейный)


```{r, child='data/линейный.html'}
```
::: {.panel-tabset}
