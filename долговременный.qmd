---
title: долговременный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/долговременный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=долговременный)


```{r, child='data/долговременный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/долговременный.qmd'}
```
