...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/касательной)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=касательной)


```{r, child='data/касательной.html'}
```
::: {.panel-tabset}
