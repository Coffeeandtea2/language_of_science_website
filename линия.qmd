...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/линия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=линия)


```{r, child='data/линия.html'}
```
::: {.panel-tabset}
