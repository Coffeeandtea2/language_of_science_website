---
title: топливноэнергетический
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/топливноэнергетический)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=топливноэнергетический)


```{r, child='data/топливноэнергетический.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'топливноэнергетический') |> 
...
```{r, child='tasks/топливноэнергетический.qmd'}
```
