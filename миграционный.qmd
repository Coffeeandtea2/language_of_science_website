...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/миграционный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=миграционный)


```{r, child='data/миграционный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/миграционный.qmd'}
```
