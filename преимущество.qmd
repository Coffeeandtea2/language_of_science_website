...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/преимущество)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=преимущество)


```{r, child='data/преимущество.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/преимущество.qmd'}
```
