...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/целевой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=целевой)


```{r, child='data/целевой.html'}
```
::: {.panel-tabset}
