...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/хозяйство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=хозяйство)


```{r, child='data/хозяйство.html'}
```
::: {.panel-tabset}
