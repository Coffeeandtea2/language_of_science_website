---
title: финансовобюджетный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/финансовобюджетный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=финансовобюджетный)


```{r, child='data/финансовобюджетный.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'финансовобюджетный') |> 
...
```{r, child='tasks/финансовобюджетный.qmd'}
```
