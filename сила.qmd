...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сила)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сила)


```{r, child='data/сила.html'}
```
::: {.panel-tabset}
