...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/убыток)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=убыток)


```{r, child='data/убыток.html'}
```
::: {.panel-tabset}
