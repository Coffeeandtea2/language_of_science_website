...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/базисный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=базисный)


```{r, child='data/базисный.html'}
```
::: {.panel-tabset}
