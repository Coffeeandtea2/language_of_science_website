...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/опцион)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=опцион)


```{r, child='data/опцион.html'}
```
::: {.panel-tabset}
