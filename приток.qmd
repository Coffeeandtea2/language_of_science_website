...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/приток)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=приток)


```{r, child='data/приток.html'}
```
::: {.panel-tabset}
