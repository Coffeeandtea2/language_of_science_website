...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/угол)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=угол)


```{r, child='data/угол.html'}
```
::: {.panel-tabset}
