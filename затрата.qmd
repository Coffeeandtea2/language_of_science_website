...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/затрата)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=затрата)


```{r, child='data/затрата.html'}
```
::: {.panel-tabset}
