...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/нефтяной)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=нефтяной)


```{r, child='data/нефтяной.html'}
```
::: {.panel-tabset}
