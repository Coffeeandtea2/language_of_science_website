...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/общий)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=общий)


```{r, child='data/общий.html'}
```
::: {.panel-tabset}
