...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/привлекательность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=привлекательность)


```{r, child='data/привлекательность.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'привлекательность') |> 
...
```{r, child='tasks/привлекательность.qmd'}
```
