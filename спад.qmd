...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/спад)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=спад)


```{r, child='data/спад.html'}
```
::: {.panel-tabset}
