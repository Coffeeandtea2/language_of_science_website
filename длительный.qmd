...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/длительный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=длительный)


```{r, child='data/длительный.html'}
```
::: {.panel-tabset}
