...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/безработица)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=безработица)


```{r, child='data/безработица.html'}
```
::: {.panel-tabset}
