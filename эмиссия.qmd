...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/эмиссия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=эмиссия)


```{r, child='data/эмиссия.html'}
```
::: {.panel-tabset}
