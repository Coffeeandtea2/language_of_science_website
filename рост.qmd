...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/рост)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=рост)


```{r, child='data/рост.html'}
```
::: {.panel-tabset}
