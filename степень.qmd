...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/степень)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=степень)


```{r, child='data/степень.html'}
```
::: {.panel-tabset}
