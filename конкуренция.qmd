...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/конкуренция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=конкуренция)


```{r, child='data/конкуренция.html'}
```
::: {.panel-tabset}
