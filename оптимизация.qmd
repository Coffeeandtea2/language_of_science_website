...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/оптимизация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=оптимизация)


```{r, child='data/оптимизация.html'}
```
::: {.panel-tabset}
