...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/потребитель)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=потребитель)


```{r, child='data/потребитель.html'}
```
::: {.panel-tabset}
