...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кластерный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кластерный)


```{r, child='data/кластерный.html'}
```
::: {.panel-tabset}
