...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/безвозмездный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=безвозмездный)


```{r, child='data/безвозмездный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/безвозмездный.qmd'}
```
