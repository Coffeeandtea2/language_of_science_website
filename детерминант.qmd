...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/детерминант)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=детерминант)


```{r, child='data/детерминант.html'}
```
::: {.panel-tabset}
