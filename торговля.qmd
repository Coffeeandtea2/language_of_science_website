...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/торговля)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=торговля)


```{r, child='data/торговля.html'}
```
::: {.panel-tabset}
