---
title: макропруденциальный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/макропруденциальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=макропруденциальный)


```{r, child='data/макропруденциальный.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'макропруденциальный') |> 
...
```{r, child='tasks/макропруденциальный.qmd'}
```
