...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/переменная)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=переменная)


```{r, child='data/переменная.html'}
```
::: {.panel-tabset}
