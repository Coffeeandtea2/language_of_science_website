...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/срок)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=срок)


```{r, child='data/срок.html'}
```
::: {.panel-tabset}
