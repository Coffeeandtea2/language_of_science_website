...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/интервал)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=интервал)


```{r, child='data/интервал.html'}
```
::: {.panel-tabset}
