...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/современный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=современный)


```{r, child='data/современный.html'}
```
::: {.panel-tabset}
