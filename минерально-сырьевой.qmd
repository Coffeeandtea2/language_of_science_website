---
title: минерально-сырьевой
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/минерально-сырьевой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=минерально-сырьевой)


```{r, child='data/минерально-сырьевой.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'минерально-сырьевой') |> 
...
```{r, child='tasks/минерально-сырьевой.qmd'}
```
