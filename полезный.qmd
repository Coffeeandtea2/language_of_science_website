...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/полезный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=полезный)


```{r, child='data/полезный.html'}
```
::: {.panel-tabset}
