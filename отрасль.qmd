...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/отрасль)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=отрасль)


```{r, child='data/отрасль.html'}
```
::: {.panel-tabset}
