...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/барьер)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=барьер)


```{r, child='data/барьер.html'}
```
::: {.panel-tabset}
