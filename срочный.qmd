...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/срочный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=срочный)


```{r, child='data/срочный.html'}
```
::: {.panel-tabset}
