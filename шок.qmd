...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/шок)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=шок)


```{r, child='data/шок.html'}
```
::: {.panel-tabset}
