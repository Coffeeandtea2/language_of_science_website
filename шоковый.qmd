...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/шоковый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=шоковый)


```{r, child='data/шоковый.html'}
```
::: {.panel-tabset}
