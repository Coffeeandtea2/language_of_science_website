...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/пошлина)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=пошлина)


```{r, child='data/пошлина.html'}
```
::: {.panel-tabset}
