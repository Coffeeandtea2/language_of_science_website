...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/оплата)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=оплата)


```{r, child='data/оплата.html'}
```
::: {.panel-tabset}
