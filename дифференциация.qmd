...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/дифференциация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=дифференциация)


```{r, child='data/дифференциация.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/дифференциация.qmd'}
```
