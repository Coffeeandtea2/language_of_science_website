...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/купон)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=купон)


```{r, child='data/купон.html'}
```
::: {.panel-tabset}
