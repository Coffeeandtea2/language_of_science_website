...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/пенсия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=пенсия)


```{r, child='data/пенсия.html'}
```
::: {.panel-tabset}
