...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/индекс)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=индекс)


```{r, child='data/индекс.html'}
```
::: {.panel-tabset}
