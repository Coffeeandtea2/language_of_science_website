...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/смешанный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=смешанный)


```{r, child='data/смешанный.html'}
```
::: {.panel-tabset}
