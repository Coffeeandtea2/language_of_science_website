---
title: продовольственный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/продовольственный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=продовольственный)


```{r, child='data/продовольственный.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'продовольственный') |> 
...
```{r, child='tasks/продовольственный.qmd'}
```
