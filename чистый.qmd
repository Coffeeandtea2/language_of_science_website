...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/чистый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=чистый)


```{r, child='data/чистый.html'}
```
::: {.panel-tabset}
