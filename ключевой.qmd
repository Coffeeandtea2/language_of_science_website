...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ключевой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ключевой)


```{r, child='data/ключевой.html'}
```
::: {.panel-tabset}
