...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/промышленность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=промышленность)


```{r, child='data/промышленность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/промышленность.qmd'}
```
