...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/маржа)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=маржа)


```{r, child='data/маржа.html'}
```
::: {.panel-tabset}
