...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/монополист)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=монополист)


```{r, child='data/монополист.html'}
```
::: {.panel-tabset}
