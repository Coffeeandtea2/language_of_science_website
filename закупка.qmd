...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/закупка)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=закупка)


```{r, child='data/закупка.html'}
```
::: {.panel-tabset}
