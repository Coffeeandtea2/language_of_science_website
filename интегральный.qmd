...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/интегральный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=интегральный)


```{r, child='data/интегральный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/интегральный.qmd'}
```
