...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/потеря)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=потеря)


```{r, child='data/потеря.html'}
```
::: {.panel-tabset}
