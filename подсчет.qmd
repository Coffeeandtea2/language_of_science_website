...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/подсчет)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=подсчет)


```{r, child='data/подсчет.html'}
```
::: {.panel-tabset}
