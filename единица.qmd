...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/единица)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=единица)


```{r, child='data/единица.html'}
```
::: {.panel-tabset}
