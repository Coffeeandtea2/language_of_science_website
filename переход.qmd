...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/переход)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=переход)


```{r, child='data/переход.html'}
```
::: {.panel-tabset}
