...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/аграрный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=аграрный)


```{r, child='data/аграрный.html'}
```
::: {.panel-tabset}
