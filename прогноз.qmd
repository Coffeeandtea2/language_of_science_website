...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/прогноз)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=прогноз)


```{r, child='data/прогноз.html'}
```
::: {.panel-tabset}
