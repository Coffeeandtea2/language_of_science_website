...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/акция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=акция)


```{r, child='data/акция.html'}
```
::: {.panel-tabset}
