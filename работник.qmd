...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/работник)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=работник)


```{r, child='data/работник.html'}
```
::: {.panel-tabset}
