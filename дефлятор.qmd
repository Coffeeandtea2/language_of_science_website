...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/дефлятор)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=дефлятор)


```{r, child='data/дефлятор.html'}
```
::: {.panel-tabset}
