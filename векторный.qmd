...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/векторный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=векторный)


```{r, child='data/векторный.html'}
```
::: {.panel-tabset}
