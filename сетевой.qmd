...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сетевой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сетевой)


```{r, child='data/сетевой.html'}
```
::: {.panel-tabset}
