...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/жилой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=жилой)


```{r, child='data/жилой.html'}
```
::: {.panel-tabset}
