...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/акционерный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=акционерный)


```{r, child='data/акционерный.html'}
```
::: {.panel-tabset}
