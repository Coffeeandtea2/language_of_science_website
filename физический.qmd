...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/физический)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=физический)


```{r, child='data/физический.html'}
```
::: {.panel-tabset}
