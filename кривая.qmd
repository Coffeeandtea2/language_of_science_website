...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кривая)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кривая)


```{r, child='data/кривая.html'}
```
::: {.panel-tabset}
