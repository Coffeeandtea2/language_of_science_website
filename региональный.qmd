...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/региональный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=региональный)


```{r, child='data/региональный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/региональный.qmd'}
```
