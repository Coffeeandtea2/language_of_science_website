...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/импульсный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=импульсный)


```{r, child='data/импульсный.html'}
```
::: {.panel-tabset}
