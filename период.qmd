...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/период)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=период)


```{r, child='data/период.html'}
```
::: {.panel-tabset}
