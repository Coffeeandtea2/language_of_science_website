...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/показатель)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=показатель)


```{r, child='data/показатель.html'}
```
::: {.panel-tabset}
