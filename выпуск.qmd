...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/выпуск)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=выпуск)


```{r, child='data/выпуск.html'}
```
::: {.panel-tabset}
