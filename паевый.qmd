...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/паевый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=паевый)


```{r, child='data/паевый.html'}
```
::: {.panel-tabset}
