...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/единый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=единый)


```{r, child='data/единый.html'}
```
::: {.panel-tabset}
