...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/богатство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=богатство)


```{r, child='data/богатство.html'}
```
::: {.panel-tabset}
