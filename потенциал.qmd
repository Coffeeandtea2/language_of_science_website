...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/потенциал)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=потенциал)


```{r, child='data/потенциал.html'}
```
::: {.panel-tabset}
