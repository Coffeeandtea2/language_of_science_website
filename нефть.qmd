...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/нефть)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=нефть)


```{r, child='data/нефть.html'}
```
::: {.panel-tabset}
