...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/валовой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=валовой)


```{r, child='data/валовой.html'}
```
::: {.panel-tabset}
