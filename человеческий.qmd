...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/человеческий)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=человеческий)


```{r, child='data/человеческий.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/человеческий.qmd'}
```
