...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/механизм)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=механизм)


```{r, child='data/механизм.html'}
```
::: {.panel-tabset}
