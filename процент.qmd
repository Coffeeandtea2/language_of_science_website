...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/процент)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=процент)


```{r, child='data/процент.html'}
```
::: {.panel-tabset}
