...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/душа)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=душа)


```{r, child='data/душа.html'}
```
::: {.panel-tabset}
