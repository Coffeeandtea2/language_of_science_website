...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/реакция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=реакция)


```{r, child='data/реакция.html'}
```
::: {.panel-tabset}
