...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/коэффициент)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=коэффициент)


```{r, child='data/коэффициент.html'}
```
::: {.panel-tabset}
