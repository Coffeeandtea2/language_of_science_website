...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/безвозвратный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=безвозвратный)


```{r, child='data/безвозвратный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/безвозвратный.qmd'}
```
