...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/долг)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=долг)


```{r, child='data/долг.html'}
```
::: {.panel-tabset}
