---
title: кредитно-денежный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кредитно-денежный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кредитно-денежный)


```{r, child='data/кредитно-денежный.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'кредитно-денежный') |> 
...
```{r, child='tasks/кредитно-денежный.qmd'}
```
