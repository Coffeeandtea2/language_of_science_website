...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/пособие)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=пособие)


```{r, child='data/пособие.html'}
```
::: {.panel-tabset}
