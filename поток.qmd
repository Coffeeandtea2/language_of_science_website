...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/поток)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=поток)


```{r, child='data/поток.html'}
```
::: {.panel-tabset}
