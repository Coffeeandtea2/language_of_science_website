...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/пенсионный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=пенсионный)


```{r, child='data/пенсионный.html'}
```
::: {.panel-tabset}
