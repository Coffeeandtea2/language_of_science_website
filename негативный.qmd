...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/негативный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=негативный)


```{r, child='data/негативный.html'}
```
::: {.panel-tabset}
