...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/вычет)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=вычет)


```{r, child='data/вычет.html'}
```
::: {.panel-tabset}
