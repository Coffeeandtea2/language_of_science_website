...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ценовой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ценовой)


```{r, child='data/ценовой.html'}
```
::: {.panel-tabset}
