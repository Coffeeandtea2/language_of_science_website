...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/состав)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=состав)


```{r, child='data/состав.html'}
```
::: {.panel-tabset}
