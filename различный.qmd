...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/различный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=различный)


```{r, child='data/различный.html'}
```
::: {.panel-tabset}
