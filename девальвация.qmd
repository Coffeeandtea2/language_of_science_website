...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/девальвация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=девальвация)


```{r, child='data/девальвация.html'}
```
::: {.panel-tabset}
