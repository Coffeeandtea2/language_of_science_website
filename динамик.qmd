...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/динамик)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=динамик)


```{r, child='data/динамик.html'}
```
::: {.panel-tabset}
