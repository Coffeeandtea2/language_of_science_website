...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/разработка)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=разработка)


```{r, child='data/разработка.html'}
```
::: {.panel-tabset}
