...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/координата)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=координата)


```{r, child='data/координата.html'}
```
::: {.panel-tabset}
