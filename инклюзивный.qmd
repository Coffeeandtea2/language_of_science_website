...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/инклюзивный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=инклюзивный)


```{r, child='data/инклюзивный.html'}
```
::: {.panel-tabset}
