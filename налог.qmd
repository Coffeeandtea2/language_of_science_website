...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/налог)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=налог)


```{r, child='data/налог.html'}
```
::: {.panel-tabset}
