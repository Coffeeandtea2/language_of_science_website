...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сектор)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сектор)


```{r, child='data/сектор.html'}
```
::: {.panel-tabset}
