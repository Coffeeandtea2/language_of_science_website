...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/наемный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=наемный)


```{r, child='data/наемный.html'}
```
::: {.panel-tabset}
