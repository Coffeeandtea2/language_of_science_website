...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/систематический)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=систематический)


```{r, child='data/систематический.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/систематический.qmd'}
```
