...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/учетный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=учетный)


```{r, child='data/учетный.html'}
```
::: {.panel-tabset}
