...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/множество)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=множество)


```{r, child='data/множество.html'}
```
::: {.panel-tabset}
