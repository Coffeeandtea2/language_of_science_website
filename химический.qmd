...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/химический)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=химический)


```{r, child='data/химический.html'}
```
::: {.panel-tabset}
