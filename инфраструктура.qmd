...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/инфраструктура)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=инфраструктура)


```{r, child='data/инфраструктура.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/инфраструктура.qmd'}
```
