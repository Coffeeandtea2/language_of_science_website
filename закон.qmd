...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/закон)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=закон)


```{r, child='data/закон.html'}
```
::: {.panel-tabset}
