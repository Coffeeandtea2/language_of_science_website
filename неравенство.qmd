...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/неравенство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=неравенство)


```{r, child='data/неравенство.html'}
```
::: {.panel-tabset}
