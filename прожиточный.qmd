...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/прожиточный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=прожиточный)


```{r, child='data/прожиточный.html'}
```
::: {.panel-tabset}
