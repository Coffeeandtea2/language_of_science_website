...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/диаграмма)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=диаграмма)


```{r, child='data/диаграмма.html'}
```
::: {.panel-tabset}
