...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кредиторский)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кредиторский)


```{r, child='data/кредиторский.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/кредиторский.qmd'}
```
