...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/производитель)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=производитель)


```{r, child='data/производитель.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/производитель.qmd'}
```
