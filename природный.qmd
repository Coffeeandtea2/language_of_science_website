...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/природный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=природный)


```{r, child='data/природный.html'}
```
::: {.panel-tabset}
