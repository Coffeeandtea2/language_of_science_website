...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/обязательство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=обязательство)


```{r, child='data/обязательство.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/обязательство.qmd'}
```
