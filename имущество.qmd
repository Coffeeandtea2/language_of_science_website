...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/имущество)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=имущество)


```{r, child='data/имущество.html'}
```
::: {.panel-tabset}
