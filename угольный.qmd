...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/угольный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=угольный)


```{r, child='data/угольный.html'}
```
::: {.panel-tabset}
