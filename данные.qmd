...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/данные)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=данные)


```{r, child='data/данные.html'}
```
::: {.panel-tabset}
