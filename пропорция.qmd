...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/пропорция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=пропорция)


```{r, child='data/пропорция.html'}
```
::: {.panel-tabset}
