...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/удельный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=удельный)


```{r, child='data/удельный.html'}
```
::: {.panel-tabset}
