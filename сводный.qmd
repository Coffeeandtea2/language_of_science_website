...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сводный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сводный)


```{r, child='data/сводный.html'}
```
::: {.panel-tabset}
