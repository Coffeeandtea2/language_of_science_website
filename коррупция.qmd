...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/коррупция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=коррупция)


```{r, child='data/коррупция.html'}
```
::: {.panel-tabset}
