...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/революция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=революция)


```{r, child='data/революция.html'}
```
::: {.panel-tabset}
