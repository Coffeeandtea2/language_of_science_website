...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/курс)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=курс)


```{r, child='data/курс.html'}
```
::: {.panel-tabset}
