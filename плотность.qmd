...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/плотность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=плотность)


```{r, child='data/плотность.html'}
```
::: {.panel-tabset}
