...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/задолженность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=задолженность)


```{r, child='data/задолженность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/задолженность.qmd'}
```
