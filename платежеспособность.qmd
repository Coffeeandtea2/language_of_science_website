...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/платежеспособность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=платежеспособность)


```{r, child='data/платежеспособность.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'платежеспособность') |> 
...
```{r, child='tasks/платежеспособность.qmd'}
```
