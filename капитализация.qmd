...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/капитализация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=капитализация)


```{r, child='data/капитализация.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/капитализация.qmd'}
```
