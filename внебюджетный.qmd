...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/внебюджетный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=внебюджетный)


```{r, child='data/внебюджетный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/внебюджетный.qmd'}
```
