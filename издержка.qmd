...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/издержка)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=издержка)


```{r, child='data/издержка.html'}
```
::: {.panel-tabset}
