...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/бюджет)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=бюджет)


```{r, child='data/бюджет.html'}
```
::: {.panel-tabset}
