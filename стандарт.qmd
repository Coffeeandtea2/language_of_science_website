...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/стандарт)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=стандарт)


```{r, child='data/стандарт.html'}
```
::: {.panel-tabset}
