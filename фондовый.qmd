...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/фондовый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=фондовый)


```{r, child='data/фондовый.html'}
```
::: {.panel-tabset}
