...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/дисбаланс)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=дисбаланс)


```{r, child='data/дисбаланс.html'}
```
::: {.panel-tabset}
