...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/асимметрия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=асимметрия)


```{r, child='data/асимметрия.html'}
```
::: {.panel-tabset}
