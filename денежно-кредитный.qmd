---
title: денежно-кредитный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/денежно-кредитный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=денежно-кредитный)


```{r, child='data/денежно-кредитный.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'денежно-кредитный') |> 
...
```{r, child='tasks/денежно-кредитный.qmd'}
```
