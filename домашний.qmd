...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/домашний)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=домашний)


```{r, child='data/домашний.html'}
```
::: {.panel-tabset}
