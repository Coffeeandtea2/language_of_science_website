...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/антикризисный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=антикризисный)


```{r, child='data/антикризисный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/антикризисный.qmd'}
```
