...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/муниципальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=муниципальный)


```{r, child='data/муниципальный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/муниципальный.qmd'}
```
