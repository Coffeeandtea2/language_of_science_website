...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/двойной)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=двойной)


```{r, child='data/двойной.html'}
```
::: {.panel-tabset}
