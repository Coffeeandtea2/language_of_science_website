...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/экологический)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=экологический)


```{r, child='data/экологический.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/экологический.qmd'}
```
