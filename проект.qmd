...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/проект)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=проект)


```{r, child='data/проект.html'}
```
::: {.panel-tabset}
