...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/газовый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=газовый)


```{r, child='data/газовый.html'}
```
::: {.panel-tabset}
