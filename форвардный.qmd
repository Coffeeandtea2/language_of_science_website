...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/форвардный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=форвардный)


```{r, child='data/форвардный.html'}
```
::: {.panel-tabset}
