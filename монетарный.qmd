...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/монетарный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=монетарный)


```{r, child='data/монетарный.html'}
```
::: {.panel-tabset}
