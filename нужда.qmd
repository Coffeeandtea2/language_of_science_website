...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/нужда)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=нужда)


```{r, child='data/нужда.html'}
```
::: {.panel-tabset}
