...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/недвижимый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=недвижимый)


```{r, child='data/недвижимый.html'}
```
::: {.panel-tabset}
