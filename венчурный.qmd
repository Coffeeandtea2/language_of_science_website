...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/венчурный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=венчурный)


```{r, child='data/венчурный.html'}
```
::: {.panel-tabset}
