...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/смертность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=смертность)


```{r, child='data/смертность.html'}
```
::: {.panel-tabset}
