...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/экспортный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=экспортный)


```{r, child='data/экспортный.html'}
```
::: {.panel-tabset}
