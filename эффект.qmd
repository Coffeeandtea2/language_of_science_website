...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/эффект)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=эффект)


```{r, child='data/эффект.html'}
```
::: {.panel-tabset}
