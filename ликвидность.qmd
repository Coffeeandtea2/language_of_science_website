...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ликвидность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ликвидность)


```{r, child='data/ликвидность.html'}
```
::: {.panel-tabset}
