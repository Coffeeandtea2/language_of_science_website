...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/облигация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=облигация)


```{r, child='data/облигация.html'}
```
::: {.panel-tabset}
