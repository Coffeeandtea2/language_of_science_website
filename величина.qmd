...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/величина)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=величина)


```{r, child='data/величина.html'}
```
::: {.panel-tabset}
