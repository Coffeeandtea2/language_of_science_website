...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/адаптация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=адаптация)


```{r, child='data/адаптация.html'}
```
::: {.panel-tabset}
