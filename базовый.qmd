...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/базовый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=базовый)


```{r, child='data/базовый.html'}
```
::: {.panel-tabset}
