...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/доходный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=доходный)


```{r, child='data/доходный.html'}
```
::: {.panel-tabset}
