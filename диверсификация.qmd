...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/диверсификация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=диверсификация)


```{r, child='data/диверсификация.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/диверсификация.qmd'}
```
