...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/субсидирование)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=субсидирование)


```{r, child='data/субсидирование.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/субсидирование.qmd'}
```
