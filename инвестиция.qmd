...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/инвестиция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=инвестиция)


```{r, child='data/инвестиция.html'}
```
::: {.panel-tabset}
