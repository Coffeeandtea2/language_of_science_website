...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/мультипликатор)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=мультипликатор)


```{r, child='data/мультипликатор.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/мультипликатор.qmd'}
```
