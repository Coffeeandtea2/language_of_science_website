...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/стабильный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=стабильный)


```{r, child='data/стабильный.html'}
```
::: {.panel-tabset}
