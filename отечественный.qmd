...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/отечественный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=отечественный)


```{r, child='data/отечественный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/отечественный.qmd'}
```
