...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/банкротство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=банкротство)


```{r, child='data/банкротство.html'}
```
::: {.panel-tabset}
