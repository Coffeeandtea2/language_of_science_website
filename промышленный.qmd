...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/промышленный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=промышленный)


```{r, child='data/промышленный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/промышленный.qmd'}
```
