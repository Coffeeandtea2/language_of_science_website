...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/базис)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=базис)


```{r, child='data/базис.html'}
```
::: {.panel-tabset}
