...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/растровый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=растровый)


```{r, child='data/растровый.html'}
```
::: {.panel-tabset}
