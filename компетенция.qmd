...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/компетенция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=компетенция)


```{r, child='data/компетенция.html'}
```
::: {.panel-tabset}
