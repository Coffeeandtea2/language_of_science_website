...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/безрисковый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=безрисковый)


```{r, child='data/безрисковый.html'}
```
::: {.panel-tabset}
