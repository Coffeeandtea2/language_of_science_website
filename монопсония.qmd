...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/монопсония)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=монопсония)


```{r, child='data/монопсония.html'}
```
::: {.panel-tabset}
