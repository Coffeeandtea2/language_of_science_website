...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/орган)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=орган)


```{r, child='data/орган.html'}
```
::: {.panel-tabset}
