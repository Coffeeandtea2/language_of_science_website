...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/расход)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=расход)


```{r, child='data/расход.html'}
```
::: {.panel-tabset}
