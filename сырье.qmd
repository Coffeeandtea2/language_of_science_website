...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сырье)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сырье)


```{r, child='data/сырье.html'}
```
::: {.panel-tabset}
