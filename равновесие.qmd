...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/равновесие)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=равновесие)


```{r, child='data/равновесие.html'}
```
::: {.panel-tabset}
