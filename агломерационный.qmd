---
title: агломерационный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/агломерационный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=агломерационный)


```{r, child='data/агломерационный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/агломерационный.qmd'}
```
