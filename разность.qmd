...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/разность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=разность)


```{r, child='data/разность.html'}
```
::: {.panel-tabset}
