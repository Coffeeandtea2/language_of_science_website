...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/собственность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=собственность)


```{r, child='data/собственность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/собственность.qmd'}
```
