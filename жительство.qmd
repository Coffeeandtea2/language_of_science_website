...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/жительство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=жительство)


```{r, child='data/жительство.html'}
```
::: {.panel-tabset}
