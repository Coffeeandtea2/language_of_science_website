...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/агент)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=агент)


```{r, child='data/агент.html'}
```
::: {.panel-tabset}
