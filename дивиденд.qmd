...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/дивиденд)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=дивиденд)


```{r, child='data/дивиденд.html'}
```
::: {.panel-tabset}
