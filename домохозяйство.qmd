...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/домохозяйство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=домохозяйство)


```{r, child='data/домохозяйство.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/домохозяйство.qmd'}
```
