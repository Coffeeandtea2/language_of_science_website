...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/стоимость)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=стоимость)


```{r, child='data/стоимость.html'}
```
::: {.panel-tabset}
