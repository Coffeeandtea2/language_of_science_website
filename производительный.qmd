...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/производительный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=производительный)


```{r, child='data/производительный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/производительный.qmd'}
```
