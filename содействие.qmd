...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/содействие)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=содействие)


```{r, child='data/содействие.html'}
```
::: {.panel-tabset}
