...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/рабочий)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=рабочий)


```{r, child='data/рабочий.html'}
```
::: {.panel-tabset}
