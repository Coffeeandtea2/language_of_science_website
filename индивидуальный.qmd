...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/индивидуальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=индивидуальный)


```{r, child='data/индивидуальный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/индивидуальный.qmd'}
```
