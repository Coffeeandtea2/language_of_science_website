...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/власть)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=власть)


```{r, child='data/власть.html'}
```
::: {.panel-tabset}
