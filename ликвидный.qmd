...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ликвидный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ликвидный)


```{r, child='data/ликвидный.html'}
```
::: {.panel-tabset}
