...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/платеж)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=платеж)


```{r, child='data/платеж.html'}
```
::: {.panel-tabset}
