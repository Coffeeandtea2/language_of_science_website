...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/внутренний)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=внутренний)


```{r, child='data/внутренний.html'}
```
::: {.panel-tabset}
