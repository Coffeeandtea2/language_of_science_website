...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/конкурентоспособность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=конкурентоспособность)


```{r, child='data/конкурентоспособность.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'конкурентоспособность') |> 
...
```{r, child='tasks/конкурентоспособность.qmd'}
```
