...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/провал)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=провал)


```{r, child='data/провал.html'}
```
::: {.panel-tabset}
