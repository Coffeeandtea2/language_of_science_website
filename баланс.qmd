...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/баланс)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=баланс)


```{r, child='data/баланс.html'}
```
::: {.panel-tabset}
