...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/приватизация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=приватизация)


```{r, child='data/приватизация.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/приватизация.qmd'}
```
