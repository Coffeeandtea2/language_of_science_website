...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/импортер)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=импортер)


```{r, child='data/импортер.html'}
```
::: {.panel-tabset}
