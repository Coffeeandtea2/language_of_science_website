...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сырьевой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сырьевой)


```{r, child='data/сырьевой.html'}
```
::: {.panel-tabset}
