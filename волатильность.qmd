...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/волатильность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=волатильность)


```{r, child='data/волатильность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/волатильность.qmd'}
```
