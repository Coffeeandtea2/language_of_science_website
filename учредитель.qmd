...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/учредитель)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=учредитель)


```{r, child='data/учредитель.html'}
```
::: {.panel-tabset}
