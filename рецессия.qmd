...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/рецессия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=рецессия)


```{r, child='data/рецессия.html'}
```
::: {.panel-tabset}
