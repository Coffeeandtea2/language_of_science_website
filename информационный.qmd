...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/информационный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=информационный)


```{r, child='data/информационный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/информационный.qmd'}
```
