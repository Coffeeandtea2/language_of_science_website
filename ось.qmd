...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ось)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ось)


```{r, child='data/ось.html'}
```
::: {.panel-tabset}
