...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/жилье)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=жилье)


```{r, child='data/жилье.html'}
```
::: {.panel-tabset}
