...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/заемный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=заемный)


```{r, child='data/заемный.html'}
```
::: {.panel-tabset}
