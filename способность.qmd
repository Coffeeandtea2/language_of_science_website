...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/способность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=способность)


```{r, child='data/способность.html'}
```
::: {.panel-tabset}
