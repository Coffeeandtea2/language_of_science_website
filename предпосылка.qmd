...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/предпосылка)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=предпосылка)


```{r, child='data/предпосылка.html'}
```
::: {.panel-tabset}
