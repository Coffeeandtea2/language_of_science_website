...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/международный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=международный)


```{r, child='data/международный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/международный.qmd'}
```
