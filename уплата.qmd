...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/уплата)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=уплата)


```{r, child='data/уплата.html'}
```
::: {.panel-tabset}
