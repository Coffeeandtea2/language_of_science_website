...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/позитивный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=позитивный)


```{r, child='data/позитивный.html'}
```
::: {.panel-tabset}
