---
title: внешнеэкономический
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/внешнеэкономический)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=внешнеэкономический)


```{r, child='data/внешнеэкономический.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'внешнеэкономический') |> 
...
```{r, child='tasks/внешнеэкономический.qmd'}
```
