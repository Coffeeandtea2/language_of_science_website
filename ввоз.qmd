...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ввоз)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ввоз)


```{r, child='data/ввоз.html'}
```
::: {.panel-tabset}
