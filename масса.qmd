...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/масса)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=масса)


```{r, child='data/масса.html'}
```
::: {.panel-tabset}
