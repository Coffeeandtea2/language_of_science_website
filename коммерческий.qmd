...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/коммерческий)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=коммерческий)


```{r, child='data/коммерческий.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/коммерческий.qmd'}
```
