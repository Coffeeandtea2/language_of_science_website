...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/заем)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=заем)


```{r, child='data/заем.html'}
```
::: {.panel-tabset}
