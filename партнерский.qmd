...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/партнерский)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=партнерский)


```{r, child='data/партнерский.html'}
```
::: {.panel-tabset}
