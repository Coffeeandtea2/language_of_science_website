...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/учет)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=учет)


```{r, child='data/учет.html'}
```
::: {.panel-tabset}
