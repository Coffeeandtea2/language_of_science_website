...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/деловой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=деловой)


```{r, child='data/деловой.html'}
```
::: {.panel-tabset}
