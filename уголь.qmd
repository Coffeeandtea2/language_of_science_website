...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/уголь)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=уголь)


```{r, child='data/уголь.html'}
```
::: {.panel-tabset}
