...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/свойство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=свойство)


```{r, child='data/свойство.html'}
```
::: {.panel-tabset}
