...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/казначейство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=казначейство)


```{r, child='data/казначейство.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/казначейство.qmd'}
```
