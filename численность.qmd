...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/численность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=численность)


```{r, child='data/численность.html'}
```
::: {.panel-tabset}
