...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/текущий)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=текущий)


```{r, child='data/текущий.html'}
```
::: {.panel-tabset}
