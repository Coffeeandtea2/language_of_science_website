...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/налогообложение)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=налогообложение)


```{r, child='data/налогообложение.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/налогообложение.qmd'}
```
