...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/владелец)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=владелец)


```{r, child='data/владелец.html'}
```
::: {.panel-tabset}
