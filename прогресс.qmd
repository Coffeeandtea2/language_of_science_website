...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/прогресс)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=прогресс)


```{r, child='data/прогресс.html'}
```
::: {.panel-tabset}
