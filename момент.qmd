...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/момент)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=момент)


```{r, child='data/момент.html'}
```
::: {.panel-tabset}
