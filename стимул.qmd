...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/стимул)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=стимул)


```{r, child='data/стимул.html'}
```
::: {.panel-tabset}
