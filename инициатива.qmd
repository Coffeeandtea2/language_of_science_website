...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/инициатива)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=инициатива)


```{r, child='data/инициатива.html'}
```
::: {.panel-tabset}
