...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/инфляционный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=инфляционный)


```{r, child='data/инфляционный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/инфляционный.qmd'}
```
