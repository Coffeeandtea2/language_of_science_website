...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/общественный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=общественный)


```{r, child='data/общественный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/общественный.qmd'}
```
