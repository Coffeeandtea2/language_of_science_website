...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сотрудничество)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сотрудничество)


```{r, child='data/сотрудничество.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/сотрудничество.qmd'}
```
