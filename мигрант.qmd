...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/мигрант)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=мигрант)


```{r, child='data/мигрант.html'}
```
::: {.panel-tabset}
