...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/инфраструктурный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=инфраструктурный)


```{r, child='data/инфраструктурный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/инфраструктурный.qmd'}
```
