...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/средства)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=средства)


```{r, child='data/средства.html'}
```
::: {.panel-tabset}
