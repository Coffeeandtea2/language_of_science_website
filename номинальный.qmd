...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/номинальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=номинальный)


```{r, child='data/номинальный.html'}
```
::: {.panel-tabset}
