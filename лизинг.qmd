...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/лизинг)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=лизинг)


```{r, child='data/лизинг.html'}
```
::: {.panel-tabset}
