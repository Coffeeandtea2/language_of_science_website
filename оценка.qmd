...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/оценка)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=оценка)


```{r, child='data/оценка.html'}
```
::: {.panel-tabset}
