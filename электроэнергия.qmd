...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/электроэнергия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=электроэнергия)


```{r, child='data/электроэнергия.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/электроэнергия.qmd'}
```
