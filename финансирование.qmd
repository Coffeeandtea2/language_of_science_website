...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/финансирование)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=финансирование)


```{r, child='data/финансирование.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/финансирование.qmd'}
```
