...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/обеспеченность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=обеспеченность)


```{r, child='data/обеспеченность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/обеспеченность.qmd'}
```
