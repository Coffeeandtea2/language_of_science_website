...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/взаимный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=взаимный)


```{r, child='data/взаимный.html'}
```
::: {.panel-tabset}
