...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/концентрация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=концентрация)


```{r, child='data/концентрация.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/концентрация.qmd'}
```
