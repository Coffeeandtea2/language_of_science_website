...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/корреляция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=корреляция)


```{r, child='data/корреляция.html'}
```
::: {.panel-tabset}
