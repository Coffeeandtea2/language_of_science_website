...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/функция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=функция)


```{r, child='data/функция.html'}
```
::: {.panel-tabset}
