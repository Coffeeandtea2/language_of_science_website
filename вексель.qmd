...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/вексель)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=вексель)


```{r, child='data/вексель.html'}
```
::: {.panel-tabset}
