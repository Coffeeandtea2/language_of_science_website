...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/трансфертный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=трансфертный)


```{r, child='data/трансфертный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/трансфертный.qmd'}
```
