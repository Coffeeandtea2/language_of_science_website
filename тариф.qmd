...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/тариф)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=тариф)


```{r, child='data/тариф.html'}
```
::: {.panel-tabset}
