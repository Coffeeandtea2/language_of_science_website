...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/документ)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=документ)


```{r, child='data/документ.html'}
```
::: {.panel-tabset}
