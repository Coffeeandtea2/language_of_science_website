...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/комиссия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=комиссия)


```{r, child='data/комиссия.html'}
```
::: {.panel-tabset}
