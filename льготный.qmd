...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/льготный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=льготный)


```{r, child='data/льготный.html'}
```
::: {.panel-tabset}
