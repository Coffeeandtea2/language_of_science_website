...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/амортизация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=амортизация)


```{r, child='data/амортизация.html'}
```
::: {.panel-tabset}
