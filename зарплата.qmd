...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/зарплата)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=зарплата)


```{r, child='data/зарплата.html'}
```
::: {.panel-tabset}
