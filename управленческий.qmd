...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/управленческий)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=управленческий)


```{r, child='data/управленческий.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/управленческий.qmd'}
```
