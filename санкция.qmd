...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/санкция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=санкция)


```{r, child='data/санкция.html'}
```
::: {.panel-tabset}
