...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/индивид)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=индивид)


```{r, child='data/индивид.html'}
```
::: {.panel-tabset}
