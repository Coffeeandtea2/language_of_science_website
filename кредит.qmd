...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кредит)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кредит)


```{r, child='data/кредит.html'}
```
::: {.panel-tabset}
