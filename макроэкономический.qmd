---
title: макроэкономический
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/макроэкономический)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=макроэкономический)


```{r, child='data/макроэкономический.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'макроэкономический') |> 
...
```{r, child='tasks/макроэкономический.qmd'}
```
