...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/вес)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=вес)


```{r, child='data/вес.html'}
```
::: {.panel-tabset}
