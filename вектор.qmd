...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/вектор)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=вектор)


```{r, child='data/вектор.html'}
```
::: {.panel-tabset}
