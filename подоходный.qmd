...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/подоходный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=подоходный)


```{r, child='data/подоходный.html'}
```
::: {.panel-tabset}
