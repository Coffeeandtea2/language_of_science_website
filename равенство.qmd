...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/равенство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=равенство)


```{r, child='data/равенство.html'}
```
::: {.panel-tabset}
