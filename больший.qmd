...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/больший)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=больший)


```{r, child='data/больший.html'}
```
::: {.panel-tabset}
