...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/фонд)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=фонд)


```{r, child='data/фонд.html'}
```
::: {.panel-tabset}
