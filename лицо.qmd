...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/лицо)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=лицо)


```{r, child='data/лицо.html'}
```
::: {.panel-tabset}
