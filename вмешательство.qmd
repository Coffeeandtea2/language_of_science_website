...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/вмешательство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=вмешательство)


```{r, child='data/вмешательство.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/вмешательство.qmd'}
```
