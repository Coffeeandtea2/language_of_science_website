...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/самоидентификация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=самоидентификация)


```{r, child='data/самоидентификация.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'самоидентификация') |> 
...
```{r, child='tasks/самоидентификация.qmd'}
```
