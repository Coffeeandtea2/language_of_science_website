...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/выгода)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=выгода)


```{r, child='data/выгода.html'}
```
::: {.panel-tabset}
