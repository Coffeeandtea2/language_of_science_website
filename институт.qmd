...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/институт)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=институт)


```{r, child='data/институт.html'}
```
::: {.panel-tabset}
