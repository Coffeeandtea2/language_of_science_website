...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/субсидия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=субсидия)


```{r, child='data/субсидия.html'}
```
::: {.panel-tabset}
