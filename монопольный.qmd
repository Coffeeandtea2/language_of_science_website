...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/монопольный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=монопольный)


```{r, child='data/монопольный.html'}
```
::: {.panel-tabset}
