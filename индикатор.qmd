...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/индикатор)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=индикатор)


```{r, child='data/индикатор.html'}
```
::: {.panel-tabset}
