...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/продажа)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=продажа)


```{r, child='data/продажа.html'}
```
::: {.panel-tabset}
