...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/минимум)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=минимум)


```{r, child='data/минимум.html'}
```
::: {.panel-tabset}
