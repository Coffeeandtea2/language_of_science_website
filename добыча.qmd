...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/добыча)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=добыча)


```{r, child='data/добыча.html'}
```
::: {.panel-tabset}
