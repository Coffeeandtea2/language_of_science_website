...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/наклон)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=наклон)


```{r, child='data/наклон.html'}
```
::: {.panel-tabset}
