...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/покрытие)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=покрытие)


```{r, child='data/покрытие.html'}
```
::: {.panel-tabset}
