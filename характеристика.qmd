...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/характеристика)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=характеристика)


```{r, child='data/характеристика.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/характеристика.qmd'}
```
