...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/материальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=материальный)


```{r, child='data/материальный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/материальный.qmd'}
```
