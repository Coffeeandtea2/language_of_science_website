...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/благо)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=благо)


```{r, child='data/благо.html'}
```
::: {.panel-tabset}
