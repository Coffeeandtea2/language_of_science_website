...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/роскошь)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=роскошь)


```{r, child='data/роскошь.html'}
```
::: {.panel-tabset}
