...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/возможность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=возможность)


```{r, child='data/возможность.html'}
```
::: {.panel-tabset}
