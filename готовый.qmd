...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/готовый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=готовый)


```{r, child='data/готовый.html'}
```
::: {.panel-tabset}
