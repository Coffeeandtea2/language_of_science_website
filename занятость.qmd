...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/занятость)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=занятость)


```{r, child='data/занятость.html'}
```
::: {.panel-tabset}
