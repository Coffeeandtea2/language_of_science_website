...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/активный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=активный)


```{r, child='data/активный.html'}
```
::: {.panel-tabset}
