...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/обратный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=обратный)


```{r, child='data/обратный.html'}
```
::: {.panel-tabset}
