...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кризис)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кризис)


```{r, child='data/кризис.html'}
```
::: {.panel-tabset}
