...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сальдо)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сальдо)


```{r, child='data/сальдо.html'}
```
::: {.panel-tabset}
