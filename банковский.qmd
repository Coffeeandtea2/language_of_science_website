...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/банковский)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=банковский)


```{r, child='data/банковский.html'}
```
::: {.panel-tabset}
