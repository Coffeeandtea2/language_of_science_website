...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/число)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=число)


```{r, child='data/число.html'}
```
::: {.panel-tabset}
