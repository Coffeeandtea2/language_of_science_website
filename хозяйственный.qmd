...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/хозяйственный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=хозяйственный)


```{r, child='data/хозяйственный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/хозяйственный.qmd'}
```
