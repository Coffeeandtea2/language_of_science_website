...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/фирма)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=фирма)


```{r, child='data/фирма.html'}
```
::: {.panel-tabset}
