...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кооперация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кооперация)


```{r, child='data/кооперация.html'}
```
::: {.panel-tabset}
