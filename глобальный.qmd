...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/глобальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=глобальный)


```{r, child='data/глобальный.html'}
```
::: {.panel-tabset}
