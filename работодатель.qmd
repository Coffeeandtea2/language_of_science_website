...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/работодатель)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=работодатель)


```{r, child='data/работодатель.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/работодатель.qmd'}
```
