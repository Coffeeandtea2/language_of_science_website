...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/паритет)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=паритет)


```{r, child='data/паритет.html'}
```
::: {.panel-tabset}
