...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кризисный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кризисный)


```{r, child='data/кризисный.html'}
```
::: {.panel-tabset}
