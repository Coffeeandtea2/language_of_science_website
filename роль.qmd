...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/роль)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=роль)


```{r, child='data/роль.html'}
```
::: {.panel-tabset}
