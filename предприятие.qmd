...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/предприятие)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=предприятие)


```{r, child='data/предприятие.html'}
```
::: {.panel-tabset}
