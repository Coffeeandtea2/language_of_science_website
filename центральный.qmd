...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/центральный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=центральный)


```{r, child='data/центральный.html'}
```
::: {.panel-tabset}
