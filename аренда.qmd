...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/аренда)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=аренда)


```{r, child='data/аренда.html'}
```
::: {.panel-tabset}
