...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/индексация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=индексация)


```{r, child='data/индексация.html'}
```
::: {.panel-tabset}
