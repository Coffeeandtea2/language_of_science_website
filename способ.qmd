...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/способ)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=способ)


```{r, child='data/способ.html'}
```
::: {.panel-tabset}
