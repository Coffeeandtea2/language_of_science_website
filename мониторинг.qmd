...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/мониторинг)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=мониторинг)


```{r, child='data/мониторинг.html'}
```
::: {.panel-tabset}
