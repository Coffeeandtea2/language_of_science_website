...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/олигополия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=олигополия)


```{r, child='data/олигополия.html'}
```
::: {.panel-tabset}
