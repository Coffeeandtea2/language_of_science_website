...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/уровень)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=уровень)


```{r, child='data/уровень.html'}
```
::: {.panel-tabset}
