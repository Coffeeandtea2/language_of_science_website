...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/контракт)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=контракт)


```{r, child='data/контракт.html'}
```
::: {.panel-tabset}
