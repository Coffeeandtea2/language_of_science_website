...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/прибыль)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=прибыль)


```{r, child='data/прибыль.html'}
```
::: {.panel-tabset}
