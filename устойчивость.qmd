...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/устойчивость)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=устойчивость)


```{r, child='data/устойчивость.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/устойчивость.qmd'}
```
