...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/отчет)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=отчет)


```{r, child='data/отчет.html'}
```
::: {.panel-tabset}
