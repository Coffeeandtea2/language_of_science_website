...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/норма)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=норма)


```{r, child='data/норма.html'}
```
::: {.panel-tabset}
