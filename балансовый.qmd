...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/балансовый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=балансовый)


```{r, child='data/балансовый.html'}
```
::: {.panel-tabset}
