...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/выход)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=выход)


```{r, child='data/выход.html'}
```
::: {.panel-tabset}
