...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/работа)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=работа)


```{r, child='data/работа.html'}
```
::: {.panel-tabset}
