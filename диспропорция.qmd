...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/диспропорция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=диспропорция)


```{r, child='data/диспропорция.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/диспропорция.qmd'}
```
