...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/дотация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=дотация)


```{r, child='data/дотация.html'}
```
::: {.panel-tabset}
