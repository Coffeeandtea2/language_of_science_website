...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/образ)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=образ)


```{r, child='data/образ.html'}
```
::: {.panel-tabset}
