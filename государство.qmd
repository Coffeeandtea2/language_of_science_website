...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/государство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=государство)


```{r, child='data/государство.html'}
```
::: {.panel-tabset}
