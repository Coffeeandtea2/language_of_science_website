...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/корпоративный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=корпоративный)


```{r, child='data/корпоративный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/корпоративный.qmd'}
```
