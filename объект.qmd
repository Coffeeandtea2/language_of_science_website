...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/объект)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=объект)


```{r, child='data/объект.html'}
```
::: {.panel-tabset}
