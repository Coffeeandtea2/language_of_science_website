...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/область)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=область)


```{r, child='data/область.html'}
```
::: {.panel-tabset}
