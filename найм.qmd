...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/найм)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=найм)


```{r, child='data/найм.html'}
```
::: {.panel-tabset}
