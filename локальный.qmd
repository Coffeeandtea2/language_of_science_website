...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/локальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=локальный)


```{r, child='data/локальный.html'}
```
::: {.panel-tabset}
