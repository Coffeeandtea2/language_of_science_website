...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/отраслевой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=отраслевой)


```{r, child='data/отраслевой.html'}
```
::: {.panel-tabset}
