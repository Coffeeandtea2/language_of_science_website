...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/суммарный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=суммарный)


```{r, child='data/суммарный.html'}
```
::: {.panel-tabset}
