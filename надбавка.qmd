...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/надбавка)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=надбавка)


```{r, child='data/надбавка.html'}
```
::: {.panel-tabset}
