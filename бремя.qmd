...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/бремя)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=бремя)


```{r, child='data/бремя.html'}
```
::: {.panel-tabset}
