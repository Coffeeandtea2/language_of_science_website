...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/страховой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=страховой)


```{r, child='data/страховой.html'}
```
::: {.panel-tabset}
