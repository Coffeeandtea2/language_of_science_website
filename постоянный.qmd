...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/постоянный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=постоянный)


```{r, child='data/постоянный.html'}
```
::: {.panel-tabset}
