...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/себестоимость)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=себестоимость)


```{r, child='data/себестоимость.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/себестоимость.qmd'}
```
