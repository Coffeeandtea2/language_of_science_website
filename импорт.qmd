...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/импорт)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=импорт)


```{r, child='data/импорт.html'}
```
::: {.panel-tabset}
