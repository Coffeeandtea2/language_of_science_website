...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/капитал)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=капитал)


```{r, child='data/капитал.html'}
```
::: {.panel-tabset}
