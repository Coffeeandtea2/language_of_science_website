...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/капитальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=капитальный)


```{r, child='data/капитальный.html'}
```
::: {.panel-tabset}
