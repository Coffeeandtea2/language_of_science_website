...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/источник)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=источник)


```{r, child='data/источник.html'}
```
::: {.panel-tabset}
