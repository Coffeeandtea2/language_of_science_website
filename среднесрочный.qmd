...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/среднесрочный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=среднесрочный)


```{r, child='data/среднесрочный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/среднесрочный.qmd'}
```
