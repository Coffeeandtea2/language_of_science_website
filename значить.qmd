...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/значить)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=значить)


```{r, child='data/значить.html'}
```
::: {.panel-tabset}
