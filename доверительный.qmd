...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/доверительный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=доверительный)


```{r, child='data/доверительный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/доверительный.qmd'}
```
