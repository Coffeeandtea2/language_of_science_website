...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/комплекс)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=комплекс)


```{r, child='data/комплекс.html'}
```
::: {.panel-tabset}
