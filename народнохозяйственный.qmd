---
title: народнохозяйственный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/народнохозяйственный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=народнохозяйственный)


```{r, child='data/народнохозяйственный.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'народнохозяйственный') |> 
...
```{r, child='tasks/народнохозяйственный.qmd'}
```
