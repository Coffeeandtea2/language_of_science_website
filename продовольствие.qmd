...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/продовольствие)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=продовольствие)


```{r, child='data/продовольствие.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/продовольствие.qmd'}
```
