...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/среда)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=среда)


```{r, child='data/среда.html'}
```
::: {.panel-tabset}
