...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/среднедушевой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=среднедушевой)


```{r, child='data/среднедушевой.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/среднедушевой.qmd'}
```
