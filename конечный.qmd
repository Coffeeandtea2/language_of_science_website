...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/конечный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=конечный)


```{r, child='data/конечный.html'}
```
::: {.panel-tabset}
