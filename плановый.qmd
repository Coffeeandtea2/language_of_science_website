...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/плановый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=плановый)


```{r, child='data/плановый.html'}
```
::: {.panel-tabset}
