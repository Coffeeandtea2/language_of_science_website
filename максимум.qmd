...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/максимум)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=максимум)


```{r, child='data/максимум.html'}
```
::: {.panel-tabset}
