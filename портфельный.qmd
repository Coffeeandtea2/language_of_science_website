...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/портфельный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=портфельный)


```{r, child='data/портфельный.html'}
```
::: {.panel-tabset}
