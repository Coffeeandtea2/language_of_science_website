...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/взимание)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=взимание)


```{r, child='data/взимание.html'}
```
::: {.panel-tabset}
