...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/портфель)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=портфель)


```{r, child='data/портфель.html'}
```
::: {.panel-tabset}
