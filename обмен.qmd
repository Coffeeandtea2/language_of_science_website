...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/обмен)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=обмен)


```{r, child='data/обмен.html'}
```
::: {.panel-tabset}
