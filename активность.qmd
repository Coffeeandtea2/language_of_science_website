...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/активность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=активность)


```{r, child='data/активность.html'}
```
::: {.panel-tabset}
