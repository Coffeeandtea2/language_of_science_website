...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кластер)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кластер)


```{r, child='data/кластер.html'}
```
::: {.panel-tabset}
