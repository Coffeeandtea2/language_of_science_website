...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/субвенция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=субвенция)


```{r, child='data/субвенция.html'}
```
::: {.panel-tabset}
