...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/водный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=водный)


```{r, child='data/водный.html'}
```
::: {.panel-tabset}
