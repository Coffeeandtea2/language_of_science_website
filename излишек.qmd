...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/излишек)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=излишек)


```{r, child='data/излишек.html'}
```
::: {.panel-tabset}
