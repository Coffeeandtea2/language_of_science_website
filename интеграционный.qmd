---
title: интеграционный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/интеграционный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=интеграционный)


```{r, child='data/интеграционный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/интеграционный.qmd'}
```
