...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/равновесный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=равновесный)


```{r, child='data/равновесный.html'}
```
::: {.panel-tabset}
