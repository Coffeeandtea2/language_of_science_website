...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ответственность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ответственность)


```{r, child='data/ответственность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/ответственность.qmd'}
```
