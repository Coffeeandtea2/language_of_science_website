...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/штраф)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=штраф)


```{r, child='data/штраф.html'}
```
::: {.panel-tabset}
