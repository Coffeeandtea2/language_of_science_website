...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/риск)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=риск)


```{r, child='data/риск.html'}
```
::: {.panel-tabset}
