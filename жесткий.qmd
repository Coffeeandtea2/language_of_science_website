...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/жесткий)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=жесткий)


```{r, child='data/жесткий.html'}
```
::: {.panel-tabset}
