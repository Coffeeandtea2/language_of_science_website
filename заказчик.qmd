...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/заказчик)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=заказчик)


```{r, child='data/заказчик.html'}
```
::: {.panel-tabset}
