...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/цепочка)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=цепочка)


```{r, child='data/цепочка.html'}
```
::: {.panel-tabset}
