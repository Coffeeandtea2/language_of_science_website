...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/нетрудоспособность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=нетрудоспособность)


```{r, child='data/нетрудоспособность.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'нетрудоспособность') |> 
...
```{r, child='tasks/нетрудоспособность.qmd'}
```
