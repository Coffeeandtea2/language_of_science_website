...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/конкурентный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=конкурентный)


```{r, child='data/конкурентный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/конкурентный.qmd'}
```
