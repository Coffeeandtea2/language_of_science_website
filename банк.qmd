...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/банк)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=банк)


```{r, child='data/банк.html'}
```
::: {.panel-tabset}
