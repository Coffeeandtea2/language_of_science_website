...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/итог)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=итог)


```{r, child='data/итог.html'}
```
::: {.panel-tabset}
