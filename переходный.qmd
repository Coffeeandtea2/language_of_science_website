...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/переходный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=переходный)


```{r, child='data/переходный.html'}
```
::: {.panel-tabset}
