...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/конъюнктура)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=конъюнктура)


```{r, child='data/конъюнктура.html'}
```
::: {.panel-tabset}
