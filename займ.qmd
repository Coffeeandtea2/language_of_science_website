...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/займ)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=займ)


```{r, child='data/займ.html'}
```
::: {.panel-tabset}
