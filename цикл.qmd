...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/цикл)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=цикл)


```{r, child='data/цикл.html'}
```
::: {.panel-tabset}
