---
title: нематериальный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/нематериальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=нематериальный)


```{r, child='data/нематериальный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/нематериальный.qmd'}
```
