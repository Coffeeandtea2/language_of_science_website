...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/душевой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=душевой)


```{r, child='data/душевой.html'}
```
::: {.panel-tabset}
