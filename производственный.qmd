...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/производственный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=производственный)


```{r, child='data/производственный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/производственный.qmd'}
```
