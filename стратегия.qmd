...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/стратегия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=стратегия)


```{r, child='data/стратегия.html'}
```
::: {.panel-tabset}
