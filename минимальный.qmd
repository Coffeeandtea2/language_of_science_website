...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/минимальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=минимальный)


```{r, child='data/минимальный.html'}
```
::: {.panel-tabset}
