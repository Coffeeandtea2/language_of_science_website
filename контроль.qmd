...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/контроль)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=контроль)


```{r, child='data/контроль.html'}
```
::: {.panel-tabset}
