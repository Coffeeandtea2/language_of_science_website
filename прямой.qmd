...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/прямой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=прямой)


```{r, child='data/прямой.html'}
```
::: {.panel-tabset}
