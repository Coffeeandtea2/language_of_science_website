...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/воспроизводство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=воспроизводство)


```{r, child='data/воспроизводство.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/воспроизводство.qmd'}
```
