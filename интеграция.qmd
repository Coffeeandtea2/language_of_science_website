...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/интеграция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=интеграция)


```{r, child='data/интеграция.html'}
```
::: {.panel-tabset}
