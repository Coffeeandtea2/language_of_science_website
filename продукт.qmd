...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/продукт)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=продукт)


```{r, child='data/продукт.html'}
```
::: {.panel-tabset}
