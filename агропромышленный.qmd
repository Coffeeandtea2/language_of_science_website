---
title: агропромышленный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/агропромышленный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=агропромышленный)


```{r, child='data/агропромышленный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/агропромышленный.qmd'}
```
