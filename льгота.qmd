...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/льгота)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=льгота)


```{r, child='data/льгота.html'}
```
::: {.panel-tabset}
