...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/доля)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=доля)


```{r, child='data/доля.html'}
```
::: {.panel-tabset}
