...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/массовый)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=массовый)


```{r, child='data/массовый.html'}
```
::: {.panel-tabset}
