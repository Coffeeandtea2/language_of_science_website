...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/значимость)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=значимость)


```{r, child='data/значимость.html'}
```
::: {.panel-tabset}
