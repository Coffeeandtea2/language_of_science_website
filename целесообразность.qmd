...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/целесообразность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=целесообразность)


```{r, child='data/целесообразность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/целесообразность.qmd'}
```
