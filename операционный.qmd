...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/операционный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=операционный)


```{r, child='data/операционный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/операционный.qmd'}
```
