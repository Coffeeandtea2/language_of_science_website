...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/качество)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=качество)


```{r, child='data/качество.html'}
```
::: {.panel-tabset}
