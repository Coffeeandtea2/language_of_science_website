...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/положительный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=положительный)


```{r, child='data/положительный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/положительный.qmd'}
```
