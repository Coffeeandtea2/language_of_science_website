...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/бензин)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=бензин)


```{r, child='data/бензин.html'}
```
::: {.panel-tabset}
