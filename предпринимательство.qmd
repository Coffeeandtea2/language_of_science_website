...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/предпринимательство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=предпринимательство)


```{r, child='data/предпринимательство.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'предпринимательство') |> 
...
```{r, child='tasks/предпринимательство.qmd'}
```
