...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сумма)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сумма)


```{r, child='data/сумма.html'}
```
::: {.panel-tabset}
