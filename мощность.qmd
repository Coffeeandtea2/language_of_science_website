...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/мощность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=мощность)


```{r, child='data/мощность.html'}
```
::: {.panel-tabset}
