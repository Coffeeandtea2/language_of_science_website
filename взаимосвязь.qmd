...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/взаимосвязь)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=взаимосвязь)


```{r, child='data/взаимосвязь.html'}
```
::: {.panel-tabset}
