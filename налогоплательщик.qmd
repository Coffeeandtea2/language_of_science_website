...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/налогоплательщик)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=налогоплательщик)


```{r, child='data/налогоплательщик.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/налогоплательщик.qmd'}
```
