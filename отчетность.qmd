...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/отчетность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=отчетность)


```{r, child='data/отчетность.html'}
```
::: {.panel-tabset}
