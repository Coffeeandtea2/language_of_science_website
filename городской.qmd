...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/городской)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=городской)


```{r, child='data/городской.html'}
```
::: {.panel-tabset}
