...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/премия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=премия)


```{r, child='data/премия.html'}
```
::: {.panel-tabset}
