...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/инструмент)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=инструмент)


```{r, child='data/инструмент.html'}
```
::: {.panel-tabset}
