...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/гипотеза)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=гипотеза)


```{r, child='data/гипотеза.html'}
```
::: {.panel-tabset}
