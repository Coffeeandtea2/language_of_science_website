...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/расселение)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=расселение)


```{r, child='data/расселение.html'}
```
::: {.panel-tabset}
