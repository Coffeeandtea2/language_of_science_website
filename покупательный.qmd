...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/покупательный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=покупательный)


```{r, child='data/покупательный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/покупательный.qmd'}
```
