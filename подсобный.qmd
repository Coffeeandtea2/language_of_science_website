...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/подсобный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=подсобный)


```{r, child='data/подсобный.html'}
```
::: {.panel-tabset}
