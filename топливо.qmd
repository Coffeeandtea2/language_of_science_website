...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/топливо)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=топливо)


```{r, child='data/топливо.html'}
```
::: {.panel-tabset}
