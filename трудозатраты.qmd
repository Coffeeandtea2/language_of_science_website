...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/трудозатраты)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=трудозатраты)


```{r, child='data/трудозатраты.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/трудозатраты.qmd'}
```
