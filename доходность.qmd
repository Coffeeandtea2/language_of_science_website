...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/доходность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=доходность)


```{r, child='data/доходность.html'}
```
::: {.panel-tabset}
