...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/профсоюз)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=профсоюз)


```{r, child='data/профсоюз.html'}
```
::: {.panel-tabset}
