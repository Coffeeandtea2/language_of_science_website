...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/порядок)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=порядок)


```{r, child='data/порядок.html'}
```
::: {.panel-tabset}
