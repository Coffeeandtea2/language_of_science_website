...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/абсолютный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=абсолютный)


```{r, child='data/абсолютный.html'}
```
::: {.panel-tabset}
