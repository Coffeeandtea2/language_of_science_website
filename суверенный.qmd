...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/суверенный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=суверенный)


```{r, child='data/суверенный.html'}
```
::: {.panel-tabset}
