...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/надзор)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=надзор)


```{r, child='data/надзор.html'}
```
::: {.panel-tabset}
