...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/корпорация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=корпорация)


```{r, child='data/корпорация.html'}
```
::: {.panel-tabset}
