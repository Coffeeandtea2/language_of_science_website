...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/защита)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=защита)


```{r, child='data/защита.html'}
```
::: {.panel-tabset}
