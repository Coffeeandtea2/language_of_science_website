...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/зависимость)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=зависимость)


```{r, child='data/зависимость.html'}
```
::: {.panel-tabset}
