...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ресурс)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ресурс)


```{r, child='data/ресурс.html'}
```
::: {.panel-tabset}
