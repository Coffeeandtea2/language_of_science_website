...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/максимизация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=максимизация)


```{r, child='data/максимизация.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/максимизация.qmd'}
```
