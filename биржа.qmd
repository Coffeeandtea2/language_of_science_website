...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/биржа)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=биржа)


```{r, child='data/биржа.html'}
```
::: {.panel-tabset}
