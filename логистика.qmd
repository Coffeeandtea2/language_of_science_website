...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/логистика)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=логистика)


```{r, child='data/логистика.html'}
```
::: {.panel-tabset}
