...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/машиностроение)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=машиностроение)


```{r, child='data/машиностроение.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/машиностроение.qmd'}
```
