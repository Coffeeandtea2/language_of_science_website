...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/жилищный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=жилищный)


```{r, child='data/жилищный.html'}
```
::: {.panel-tabset}
