...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/золото)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=золото)


```{r, child='data/золото.html'}
```
::: {.panel-tabset}
