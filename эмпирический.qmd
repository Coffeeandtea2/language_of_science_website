...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/эмпирический)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=эмпирический)


```{r, child='data/эмпирический.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/эмпирический.qmd'}
```
