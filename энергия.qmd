...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/энергия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=энергия)


```{r, child='data/энергия.html'}
```
::: {.panel-tabset}
