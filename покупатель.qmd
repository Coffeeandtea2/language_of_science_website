...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/покупатель)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=покупатель)


```{r, child='data/покупатель.html'}
```
::: {.panel-tabset}
