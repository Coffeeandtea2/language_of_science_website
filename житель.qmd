...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/житель)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=житель)


```{r, child='data/житель.html'}
```
::: {.panel-tabset}
