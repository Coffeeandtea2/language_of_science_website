...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/угроза)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=угроза)


```{r, child='data/угроза.html'}
```
::: {.panel-tabset}
