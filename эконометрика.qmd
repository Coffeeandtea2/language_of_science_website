...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/эконометрика)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=эконометрика)


```{r, child='data/эконометрика.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/эконометрика.qmd'}
```
