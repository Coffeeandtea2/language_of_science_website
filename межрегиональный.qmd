...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/межрегиональный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=межрегиональный)


```{r, child='data/межрегиональный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/межрегиональный.qmd'}
```
