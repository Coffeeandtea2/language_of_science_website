...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/среднегодовой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=среднегодовой)


```{r, child='data/среднегодовой.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/среднегодовой.qmd'}
```
