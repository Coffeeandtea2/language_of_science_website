...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/торги)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=торги)


```{r, child='data/торги.html'}
```
::: {.panel-tabset}
