...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/здравоохранение)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=здравоохранение)


```{r, child='data/здравоохранение.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/здравоохранение.qmd'}
```
