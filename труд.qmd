...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/труд)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=труд)


```{r, child='data/труд.html'}
```
::: {.panel-tabset}
