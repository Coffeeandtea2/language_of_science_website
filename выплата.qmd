...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/выплата)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=выплата)


```{r, child='data/выплата.html'}
```
::: {.panel-tabset}
