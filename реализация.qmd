...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/реализация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=реализация)


```{r, child='data/реализация.html'}
```
::: {.panel-tabset}
