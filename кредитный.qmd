...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кредитный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кредитный)


```{r, child='data/кредитный.html'}
```
::: {.panel-tabset}
