...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ссудный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ссудный)


```{r, child='data/ссудный.html'}
```
::: {.panel-tabset}
