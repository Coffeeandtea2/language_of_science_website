...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/эластичный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=эластичный)


```{r, child='data/эластичный.html'}
```
::: {.panel-tabset}
