...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/количество)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=количество)


```{r, child='data/количество.html'}
```
::: {.panel-tabset}
