...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/предпринимательский)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=предпринимательский)


```{r, child='data/предпринимательский.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'предпринимательский') |> 
...
```{r, child='tasks/предпринимательский.qmd'}
```
