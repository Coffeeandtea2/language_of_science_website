...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/возврат)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=возврат)


```{r, child='data/возврат.html'}
```
::: {.panel-tabset}
