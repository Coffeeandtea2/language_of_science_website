...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/организация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=организация)


```{r, child='data/организация.html'}
```
::: {.panel-tabset}
