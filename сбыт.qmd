...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сбыт)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сбыт)


```{r, child='data/сбыт.html'}
```
::: {.panel-tabset}
