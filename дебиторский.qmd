...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/дебиторский)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=дебиторский)


```{r, child='data/дебиторский.html'}
```
::: {.panel-tabset}
