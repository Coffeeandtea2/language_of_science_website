...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/профсоюзный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=профсоюзный)


```{r, child='data/профсоюзный.html'}
```
::: {.panel-tabset}
