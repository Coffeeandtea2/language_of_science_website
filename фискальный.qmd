...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/фискальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=фискальный)


```{r, child='data/фискальный.html'}
```
::: {.panel-tabset}
