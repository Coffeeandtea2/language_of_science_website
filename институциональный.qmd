...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/институциональный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=институциональный)


```{r, child='data/институциональный.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'институциональный') |> 
...
```{r, child='tasks/институциональный.qmd'}
```
