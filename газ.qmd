...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/газ)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=газ)


```{r, child='data/газ.html'}
```
::: {.panel-tabset}
