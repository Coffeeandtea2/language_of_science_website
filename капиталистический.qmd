---
title: капиталистический
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/капиталистический)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=капиталистический)


```{r, child='data/капиталистический.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'капиталистический') |> 
...
```{r, child='tasks/капиталистический.qmd'}
```
