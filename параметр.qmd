...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/параметр)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=параметр)


```{r, child='data/параметр.html'}
```
::: {.panel-tabset}
