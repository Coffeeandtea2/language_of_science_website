---
title: антиинфляционный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/антиинфляционный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=антиинфляционный)


```{r, child='data/антиинфляционный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/антиинфляционный.qmd'}
```
