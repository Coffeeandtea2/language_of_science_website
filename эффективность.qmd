...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/эффективность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=эффективность)


```{r, child='data/эффективность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/эффективность.qmd'}
```
