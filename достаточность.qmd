...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/достаточность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=достаточность)


```{r, child='data/достаточность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/достаточность.qmd'}
```
