...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/экспорт)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=экспорт)


```{r, child='data/экспорт.html'}
```
::: {.panel-tabset}
