...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/избыточный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=избыточный)


```{r, child='data/избыточный.html'}
```
::: {.panel-tabset}
