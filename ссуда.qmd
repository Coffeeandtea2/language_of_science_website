...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ссуда)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ссуда)


```{r, child='data/ссуда.html'}
```
::: {.panel-tabset}
