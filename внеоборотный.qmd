...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/внеоборотный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=внеоборотный)


```{r, child='data/внеоборотный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/внеоборотный.qmd'}
```
