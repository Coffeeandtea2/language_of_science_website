...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/рекреационный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=рекреационный)


```{r, child='data/рекреационный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/рекреационный.qmd'}
```
