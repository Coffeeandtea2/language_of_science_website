...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/рентабельность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=рентабельность)


```{r, child='data/рентабельность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/рентабельность.qmd'}
```
