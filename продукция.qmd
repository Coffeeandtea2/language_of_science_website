...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/продукция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=продукция)


```{r, child='data/продукция.html'}
```
::: {.panel-tabset}
