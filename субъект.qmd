...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/субъект)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=субъект)


```{r, child='data/субъект.html'}
```
::: {.panel-tabset}
