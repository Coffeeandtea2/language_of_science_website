...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/металлообработка)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=металлообработка)


```{r, child='data/металлообработка.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/металлообработка.qmd'}
```
