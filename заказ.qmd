...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/заказ)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=заказ)


```{r, child='data/заказ.html'}
```
::: {.panel-tabset}
