...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/совокупность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=совокупность)


```{r, child='data/совокупность.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/совокупность.qmd'}
```
