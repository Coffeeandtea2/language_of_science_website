...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/процентная)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=процентная)


```{r, child='data/процентная.html'}
```
::: {.panel-tabset}
