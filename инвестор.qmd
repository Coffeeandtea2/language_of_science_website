...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/инвестор)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=инвестор)


```{r, child='data/инвестор.html'}
```
::: {.panel-tabset}
