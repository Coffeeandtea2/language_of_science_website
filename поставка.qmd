...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/поставка)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=поставка)


```{r, child='data/поставка.html'}
```
::: {.panel-tabset}
