...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/оборот)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=оборот)


```{r, child='data/оборот.html'}
```
::: {.panel-tabset}
