...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/инновация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=инновация)


```{r, child='data/инновация.html'}
```
::: {.panel-tabset}
