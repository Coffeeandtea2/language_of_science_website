...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/утилизация)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=утилизация)


```{r, child='data/утилизация.html'}
```
::: {.panel-tabset}
