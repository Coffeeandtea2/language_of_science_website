...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/капитализм)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=капитализм)


```{r, child='data/капитализм.html'}
```
::: {.panel-tabset}
