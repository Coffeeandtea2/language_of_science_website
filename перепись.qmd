...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/перепись)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=перепись)


```{r, child='data/перепись.html'}
```
::: {.panel-tabset}
