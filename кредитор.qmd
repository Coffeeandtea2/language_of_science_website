...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кредитор)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кредитор)


```{r, child='data/кредитор.html'}
```
::: {.panel-tabset}
