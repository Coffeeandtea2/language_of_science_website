...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/ипотека)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=ипотека)


```{r, child='data/ипотека.html'}
```
::: {.panel-tabset}
