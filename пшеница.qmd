...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/пшеница)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=пшеница)


```{r, child='data/пшеница.html'}
```
::: {.panel-tabset}
