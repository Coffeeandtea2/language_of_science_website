...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/расходы)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=расходы)


```{r, child='data/расходы.html'}
```
::: {.panel-tabset}
