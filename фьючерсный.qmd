...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/фьючерсный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=фьючерсный)


```{r, child='data/фьючерсный.html'}
```
::: {.panel-tabset}
