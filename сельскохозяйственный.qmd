...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сельскохозяйственный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сельскохозяйственный)


```{r, child='data/сельскохозяйственный.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'сельскохозяйственный') |> 
...
```{r, child='tasks/сельскохозяйственный.qmd'}
```
