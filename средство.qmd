...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/средство)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=средство)


```{r, child='data/средство.html'}
```
::: {.panel-tabset}
