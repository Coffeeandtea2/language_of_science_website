...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/сберегательный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=сберегательный)


```{r, child='data/сберегательный.html'}
```
::: {.panel-tabset}
...
```{r, child='tasks/сберегательный.qmd'}
```
