...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/полугодие)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=полугодие)


```{r, child='data/полугодие.html'}
```
::: {.panel-tabset}
