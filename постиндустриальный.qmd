---
title: постиндустриальный
---

[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/постиндустриальный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=постиндустриальный)


```{r, child='data/постиндустриальный.html'}
```
::: {.panel-tabset}
...
readxl::read_xlsx('data/word_profiles.xlsx') |> 
  ...
  filter(lemma == 'постиндустриальный') |> 
...
```{r, child='tasks/постиндустриальный.qmd'}
```
