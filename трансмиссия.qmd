...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/трансмиссия)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=трансмиссия)


```{r, child='data/трансмиссия.html'}
```
::: {.panel-tabset}
