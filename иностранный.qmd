...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/иностранный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=иностранный)


```{r, child='data/иностранный.html'}
```
::: {.panel-tabset}
