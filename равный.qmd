...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/равный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=равный)


```{r, child='data/равный.html'}
```
::: {.panel-tabset}
