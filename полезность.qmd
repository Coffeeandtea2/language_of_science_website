...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/полезность)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=полезность)


```{r, child='data/полезность.html'}
```
::: {.panel-tabset}
