...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/достаточный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=достаточный)


```{r, child='data/достаточный.html'}
```
::: {.panel-tabset}
