...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/оперативный)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=оперативный)


```{r, child='data/оперативный.html'}
```
::: {.panel-tabset}
