...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/миграция)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=миграция)


```{r, child='data/миграция.html'}
```
::: {.panel-tabset}
