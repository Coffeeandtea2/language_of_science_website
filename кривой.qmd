...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/кривой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=кривой)


```{r, child='data/кривой.html'}
```
::: {.panel-tabset}
