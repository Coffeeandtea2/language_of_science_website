...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/фактический)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=фактический)


```{r, child='data/фактический.html'}
```
::: {.panel-tabset}
