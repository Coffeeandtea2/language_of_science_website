...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/экспортер)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=экспортер)


```{r, child='data/экспортер.html'}
```
::: {.panel-tabset}
