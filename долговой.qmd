...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/долговой)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=долговой)


```{r, child='data/долговой.html'}
```
::: {.panel-tabset}
