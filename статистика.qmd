...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/статистика)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=статистика)


```{r, child='data/статистика.html'}
```
::: {.panel-tabset}
