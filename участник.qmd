...
[![](images/wiktionary.png){height=7mm}](https://ru.wiktionary.org/wiki/участник)
[![](images/ruscorpora.png){height=7mm}](https://ruscorpora.ru/word/main?req=участник)


```{r, child='data/участник.html'}
```
::: {.panel-tabset}
